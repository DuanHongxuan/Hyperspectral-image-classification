...
parser.add_argument('--data_path', dest='data_path', default='./Indian_pines')
...
parser.add_argument('--cube', dest='cube', default=3) # 1 means use a pixel with vector
...
#parser.add_argument('--iter_num', dest='iter_num', default=1)
...
parser.add_argument('--n_input', dest='n_input', default=225)
parser.add_argument('--n_output', dest='n_output', default=225)
parser.add_argument('--PhaseNumber', dest='PhaseNumber', default=3)
parser.add_argument('--numComponents', dest='numComponents', default=25)
