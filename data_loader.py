...
class Data():
    ...
    def applyPCA(self,data, numComponents):
    ...
    def read_data(self):
        ...
        print("Before PCA:",data.shape)
  
        self.data = self.applyPCA(data,self.numComponents)
       
        print("after PCA:",self.data.shape)
        ...
        print("self.data_gt:",self.data_gt.shape)
